...
#define VERSION_BETA       19                              //build number of this version
#define VERSION_LEAD       0                              //build number of this version
#define IS_BETA             1                               //is this a beta?
#define DATE_STR            "14th December, 2016"
...
// 70
    ...
    wSBOOM, ewBOMB, ewSBOMB, ewBOOM, ewSBOOM, //These must be the hardcoded sprites? -Z
// 80
...
enum
{
	...
	edefSCRIPT1, edefSCRIPT2, edefSCRIPT3, edefSCRIPT4, edefSCRIPT5,
	edefSCRIPT6, edefSCRIPT7, edefSCRIPT8, edefSCRIPT9, edefSCRIPT10,
	 edefLAST
};

#define edefsMAX 29 
	//Might need to use this to size the Defense[] array instead of edefLAST
enum
{
...
struct newcombo
{
    ...
    byte skipanimy;
    byte animflags;
    byte expansion[6]; //Are these all unused? -Z
    //24
};
