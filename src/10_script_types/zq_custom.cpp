...
void setLabels(int iclass)
{
    ...
    {
        itemdata_dlg[38].dp = (void *)"<misc10>";
    ...
    {
        itemdata_dlg[139].dp = (void *)"<Attrib1>";
    ...
    {
        itemdata_dlg[141].dp = (void *)"<Attrib2>";
    ...
    {
        itemdata_dlg[143].dp = (void *)"<Attrib3>";
    ...
    {
        itemdata_dlg[145].dp = (void *)"<Attrib4>";
    ...
    {
        itemdata_dlg[147].dp = (void *)"<Attrib5>";
    ...
    {
        itemdata_dlg[149].dp = (void *)"<Attrib6>";
    ...
    {
        itemdata_dlg[151].dp = (void *)"<Attrib7>";
    ...
    {
        itemdata_dlg[153].dp = (void *)"<Attrib8>";
    ...
    {
        itemdata_dlg[155].dp = (void *)"<Attrib9>";
    ...
    {
        itemdata_dlg[157].dp = (void *)"<Attrib10>";
...
static DIALOG enedata_dlg[] =
{
    ...
    // 191
    {  jwin_text_proc,           6,    198,     80,      8,    vc(14),                 vc(1),                   0,    0,           0,    0, (void *) "Script Weapon Defense (Generic):",                              NULL,   NULL                 },
    {  jwin_droplist_proc,      126, 198-4,    115,     16,    jwin_pal[jcTEXTFG],     jwin_pal[jcTEXTBG],      0,    0,           0,    0, (void *) &defense_list,                                         NULL,   NULL                 },
    //193 - sccript 1
...
void edit_enemydata(int index)
{
    ...
    //Read the script defs. 
    for(int j=1; j <= 10; j++)
    {
        enedata_dlg[j+203].d1 = guysbuf[index].defense[j]; //Match the def to the enum value, but iterate the table index. 
    }
	...
	//Setup script defs -!ZoriaRPG
        for(int j=1; j <= 10; j++)
	{
	    test.defense[j+203] = enedata_dlg[j].d1; //Match the def to the enum value, but iterate the table index.
	}
	    ...
	    for(int j=1; j <= 10; j++)
	    {
		enedata_dlg[j+203].d1 = enedata_dlg[161].d1;
	    }
        }
    }
