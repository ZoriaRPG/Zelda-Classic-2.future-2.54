...
static ItemNameInfo inameinf[]=
{
    ...
    { itype_book, (char *)"Damage:",                         (char *)"Fire Damage:",                                         NULL,                                      NULL,                              NULL,                              NULL,                              NULL,                              NULL,                              NULL,                              NULL,                              NULL, (char *)"Fire Magic",                      NULL,                              NULL,                              NULL,                              NULL, (char *)"Magic Sprite:", (char *)"Flame Sprite:",                   NULL,                                      NULL,                                      NULL,                                      NULL,                                      NULL,                                      NULL,                                      NULL,                                      NULL, (char *)"Firing Sound:"                    },
    ...
    { itype_brang, (char *)"Damage:", (char *)"Range (0 = Infinite):",             NULL, (char *)"Block Flags:", (char *)"Reflect Flags:",          NULL,                              NULL,                              NULL,                              NULL,                              NULL,                              NULL, (char *)"Corrected Animation", (char *)"Directional Sprites", (char *)"Do Not Return",           NULL,                              (char *)"Penetrates Enemies", (char *)"Boomerang Sprite:", (char *)"Sparkle Sprite:", (char *)"Damaging Sparkle Sprite:",        NULL,                                      NULL,                                      NULL,                                      NULL,                                      NULL,                                      NULL,                                      NULL, (char *)"Spinning Sound:"                  },
...
/*
//This would need packfile modifications, to be static.
void itype_relabel(int id, char label){
	itype[itype_names] = label;
}
*/
...
//Script defs -!ZoriaRPG
//the entry points in static DIALOG enedata_dlg[] =
...
const char *defenselist(int index, int *list_size)
{
	...
	case ed1HKO:
        ...
        case edCHINKL1:
            return "Block If Power < 1";
            
        case edCHINKL2:
            return "Block If Power < 2";
            
        case edCHINKL4:
            return "Block If Power < 4";
            
        case edCHINKL6:
            return "Block If Power < 6";
            
        case edCHINKL8:
            return "Block If Power < 8";
	...
	case edLEVELDAMAGE:  //Damage * item level
		return "Damage * Item Level";
	case edLEVELREDUCTION: //Damage / item level
		return "Damage / Item Level";
	case edFREEZE: //Freeze solid
		return "Freeze Solid";
	case edSPLIT: //causes the enemy to split if it has a split attribute
		return "Split";
	case edREPLACE: //replaced by next in list?
		return "Replace/Transform";
	case edLEVELCHINK2: //If item level is < 2: This needs a weapon variable that is set by 
		return "Block if Level < 2";
	case edLEVELCHINK3: //If item level is < 3: the item that generates it (itemdata::level stored to
		return "Block if Level < 3";
	case edLEVELCHINK4: //If item level is < 4: weapon::level, or something similar; then a check to
		return "Block if Level < 4";
	case edLEVELCHINK5: //If item level is < 5: read weapon::level in hit detection. 
		return "Block if Level < 5";
	
	case edSHOCK: //buzz blob
		return "Electric Shock";
	case edEXPLODESMALL: //ew bombblast
		return "Explode (Bomb Blast)";
	case edEXPLODELARGE: //super bomb blast
		return "Explode (Super Bomb blast)";
	case edSTONE: //deadrock
		return "Turn to Stone";
	
	case edBREAKSHIELD: //break the enemy shield
		return "Break Shield";
	case edRESTORESHIELD:  //if the enemy had a shield, reset it
		return "Repair Shield";
	case edSPECIALDROP: //but where to define it?
		return "Special Dropset";
	case edINCREASECOUNTER: //but where to define the counter
		return "Increase Conter"; 
	case edREDUCECOUNTER: //same problem
		return "Reduce Counter";
	case edEXPLODEHARMLESS: //boss death explosion
		return "Explosion (Harmless)";
	
	case edKILLNOSPLIT:
		return "Kill, No Split";
