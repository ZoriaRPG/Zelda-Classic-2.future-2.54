//To expand ->D[] to 16, we need to change long d[8] in zdefs
//this would be another qheader change
...
//FFC Variables
    ...
    case FFINITDD:
    {
        ...
        if(BC::checkBounds(a, 0, 15, "ffc->InitD") != SH::_NoError)
            ret = -10000;
        else
...
//Itemdata Variables
    ...
    */
    ...
    case IDATAINITDD:
    {
        ...
        if(BC::checkBounds(a, 0, 15, "itemdata->InitD") != SH::_NoError)
            ret = -10000;
        else
...
//FFC Variables
    ...
    case FFINITDD:
        (tmpscr->initd[ri->ffcref][vbound(ri->d[0]/10000,0,15)])=value;
        break;
...
//Link's Variables
    ...
    case LINKITEMA:
	    //Link.setBButtonItem(vbound((value/10000),0,(MAXITEMS-1)));
	Awpn = vbound((value/10000),0,(MAXITEMS-1));
	break;
...
//Screen Variables
	...
	case SETITEMSLOT:
	{
		...
		int itm = ri->d[1]/10000;
		
		int slot = ri->d[0]/10000;
		int force = value/10000;
		...
		*/
		...
		if ( force == 1 ) {
			if(slot == 1 && game->item[itm]){
				...
				if ( game->item[itm] ) Bwpn = itm/10000;
			}
		}
	...
	case SETLINKTILE:
	{
		...
		switch(sprite){
			case 1: 
				walkspr[dir][spr_tile] = (int)value/10000;
			break;
			case 2: 
				floatspr[dir][spr_tile]=(int)value/10000;
			break;
			case 3: 
				swimspr[dir][spr_tile]=(int)value/10000;
			break;
			case 4: 
				divespr[dir][spr_tile]=(int)value/10000;
			break;			
			case 5: 
				slashspr[dir][spr_tile]=(int)value/10000;
			break;
			case 6:
				jumpspr[dir][spr_tile]=(int)value/10000;
			break;
			case 7: 
				chargespr[dir][spr_tile]=(int)value/10000;
			break;
			case 8:
				stabspr[dir][spr_tile]=(int)value/10000;
			break;
			case 9: 
				poundspr[dir][spr_tile]=(int)value/10000;
			break;
			case 10: 
				castingspr[spr_tile]=(int)value/10000;
			break;
			...
			break;
			case 14: 
				holdspr[spr_waterhold][spr_hold2][spr_tile]=(int)value/10000;
			break;
			default:
				walkspr[Link.getDir()][spr_tile] = (int)value/10000;
				break;
...
int run_script(const byte type, const word script, const byte i)
{
    ...
    case SCRIPT_FFC:
    {
        ...
        {
            memcpy(ri->d, tmpscr->initd[i], 16 * sizeof(long));
