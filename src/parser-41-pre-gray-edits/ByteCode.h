...
#define RESERVED0000 404
#define RESERVED0001 405
#define RESERVED0002 406
#define RESERVED0003 407
#define RESERVED0004 408
#define RESERVED0005 409
#define RESERVED0006 410
...
/*
class OGetLinkTile : public BinaryOpcode
{
public:
    OGetLinkTile(Argument *A, Argument *B) : BinaryOpcode(A,B) {}
    string toString();
    Opcode *clone()
    {
        return new OGetLinkTile(a->clone(), b->clone());
    }
};
*/
#endif
