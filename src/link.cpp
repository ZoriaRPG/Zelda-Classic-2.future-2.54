//! Link needs x and y offsets for solidity, but I'm unsure if I want to include this, as-is,
// for the user may wish to move his hitbox offsets without affecting if they also regulate solidity. 
// Should I add a flag 'HitboxSolidity', or ???
// The solidity checks will need to use hitwidth and hitheight to ensure that link can't
// phase through objects, too. 
// As I see it, there could to be a separate pair of SolidX, and SolidY for this, 
// versus his hitbox, or bool OffsetSolidity. -Z 14-Jan-2017
// Clearly, HitHeight and HitWidth should affect solidity checks, eweapon checks, but 
// what about damage combos and triggers?
...
void LinkClass::checkhit()
{
    ...
    for(int i=0; i<Lwpns.Count(); i++)
    {
        ...
        //
        if(get_bit(quest_rules,qr_Z3BRANG_HSHOT)) //How about a reflect box in the editor? -Z
        {
    ...
    */
    ...
    case itype_hookshot:
        ...
        if(use_hookshot)
        {
            ...
            //We need diagonals here, too. -Z
	    
	    //We need to set the direction based on diagonal input. Check how boomerangs to it. -Z
            if(dir==up)
            {
                hookshot_used=true;
