...
public:
    ...
    //virtual bool IsInvincible(); //to return superman status -ZoriaRPG
...
protected:
    ...
    virtual int defend(int wpnId, int *power, int *level, int edef);
    virtual int scriptdefend(int wpnId, int *power, int *level, int edef);
    bool candamage(int power, int edef);
    bool scriptcandamage(int power, int edef);
    int defenditemclass(int wpnId, int *power, int *level);
